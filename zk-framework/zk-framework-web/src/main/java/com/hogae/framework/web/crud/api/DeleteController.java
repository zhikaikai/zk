...
public interface DeleteController<ID>  extends IController<CrudService>{

    @Operation(summary = "删除",description = "ID删除")
    @DeleteMapping("/delete/{id}")
    default AppResponse deleteById(@Parameter(name = "id",description = "主键值",example = "1") @PathVariable @NotNull ID id) {
    ...
    default AppResponse deleteByIds(@RequestBody @Size(min = 1,message = "ID集合长度应大于0") ArrayList<@NotNull ID> ids){
